...
public class SwitchRec  extends LogEntity {
    ...
    public SwitchRec(int id, String time, float ropenum, float moment, float heigth, float range, float ratedweight, float weight, float rotate, float walk, float dipange, float windspeed, String remark) {
        this.id = id;
        this.time = time;
