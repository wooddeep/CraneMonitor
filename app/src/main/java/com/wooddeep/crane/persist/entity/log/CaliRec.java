...
public class CaliRec  extends LogEntity {
    ...
    public CaliRec(int id, String time, float ropenum, float moment, float heigth, float range, float ratedweight, float weight, float rotate, float walk, float dipange, float windspeed, String remark) {
        this.id = id;
        this.time = time;
