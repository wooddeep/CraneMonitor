...
public class LogDbHelper extends OrmLiteSqliteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database, ConnectionSource connectionSource) {
        try {
            TableUtils.createTableIfNotExists(connectionSource, WorkRecrod.class);
            TableUtils.createTableIfNotExists(connectionSource, RealData.class);
            TableUtils.createTableIfNotExists(connectionSource, CaliRec.class);
            TableUtils.createTableIfNotExists(connectionSource, CtrlRec.class);
            TableUtils.createTableIfNotExists(connectionSource, SwitchRec.class);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
