...
public class AlertView {
    ...
    protected void initViews(){
        ...
        int margin_alert_left_right = 400;
        switch (style){
            case ActionSheet:
                params.gravity = Gravity.BOTTOM;
                margin_alert_left_right = 400;//context.getResources().getDimensionPixelSize(R.dimen.margin_actionsheet_left_right);
            ...
            case Alert:
                ...
                margin_alert_left_right = 400;//context.getResources().getDimensionPixelSize(R.dimen.margin_alert_left_right);
